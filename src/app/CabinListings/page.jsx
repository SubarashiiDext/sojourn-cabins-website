...
export default function CabinListings() {
  ...
  return (
    <div>
        ...
        <div className=" space-x-1 mx-auto md:w-[80%] w-[100%] justify-between flex md:flex-row md:items-center items-center flex-col">
          <div className="h-[43px] w-[100px] px-2 py-1 rounded border-2 border-black-400 flex justify-between items-center ">
            ...
            <div className="flex flex-col gap-1">
              <button onClick={()=> setCount(count+1)}><BsFillCaretUpFill className="h-4 w-4" /></button>
              <button onClick={()=> setCount(count-1)}><BsFillCaretDownFill className="h-4 w-4"/></button>
            </div>
            
          </div>

          <div className="flex space-x-1 w-[95%] justify-between items-center m-1">
            <input type="text" placeholder="Input Location" className="w-[85%] h-[43px] text-  rounded border-2 border-black-400 py-1 px-2"></input>
      ...
      <Link href="CabinListings/LocationA" className="text-black">Kasoa</Link>
    </div>
  );
}
