...
export default function Card({ location, price, people, name, thumbnail }) {
  return (
    <div>
      <div className="flex items-center justify-center  ">
        <div className="mb-2 px-2 py-2 border-2 border-gray-200  rounded shadow-md hover:border-gray-100 hover:shadow-lg transition duration-200">
          <div className="rounded  overflow-hidden h-40  bg-slate-400">
            <Image
              className="object-cover object-center rounded h-40"
              src={thumbnail}
              alt=""
              width={282}
              height={336}
          ...
          <div className="mt-2">
            ...
            <div className=" text-sm">
              {people} <p className="inline">Adult(s)</p>
            </div>
            <div className=" text-sm align-baseline">
              ...
              <p className="ml-2 inline">per night</p>{" "}
            </div>
