  ...
  return (
    <div>
      <nav className=" bg-black z-99 w-[100%] sticky top-0 text-white">
        ...
        {open && (
          <div
            className="  flex flex-col items-center transition duration-700 text-white lg:hidden min-h-[100vh] pt-4"
            onClick={handleClick}
          >
            {!open ? "" : ""}
            ...
            <Link href="/Book" className="hover:text-grey-400 py-2 lg:hidden">
              BOOK
            </Link>
            <Link
              href="/CabinListings"
